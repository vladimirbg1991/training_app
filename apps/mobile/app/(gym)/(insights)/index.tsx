  ...
  return (
    <SafeAreaView className="flex-1 bg-page">
      <ScrollView className="flex-1 px-4 pt-4">
        ...
        <Text className="text-primary text-title mb-2">Leaderboard</Text>
        <Text className="text-ambient text-body-sm mb-6">
          Gym-wide insights, usage analytics, and member leaderboards.
        </Text>

        <View className="mb-4 rounded-card border border-border-subtle p-4">
          <Text className="text-ambient text-body-sm">
            Leaderboard and insights coming soon. Peak hours, popular exercises,
            member engagement metrics, and gym-wide PRs.
          </Text>
        </View>
