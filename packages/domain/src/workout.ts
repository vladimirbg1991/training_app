...
export const WorkoutSessionSchema = z.object({
  ...
  entrySource: z.enum(['manual', 'qr_scan', 'scheduled']).default('manual'),
...
export const WorkoutSetSchema = z.object({
  ...
  setGroupId: z.string().uuid().nullable().default(null),
  setGroupPosition: z.number().int().nullable().default(null),
  gymEquipmentInstanceId: z.string().uuid().nullable().default(null),
  pinPosition: z.number().int().nullable().default(null),
